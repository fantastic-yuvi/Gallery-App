    ...
    <div className="py-5 border-t-3/2">
            ...
            <div className="flex align-center justify-center mt-4">
              <p className="text-black mb-4">
                  Made with <span className = "mr-2" role="img" aria-label="heart">💙 </span>by<a className="text-pink-500 hover:text-sky-600 duration-300" href="https://fantastic-yuvi.github.io/portfolio-website/"> Yuvraj Singh Gangwar</a>
              </p>
              </div>
    </div>
  )
